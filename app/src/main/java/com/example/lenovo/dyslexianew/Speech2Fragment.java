...
public class Speech2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_speech2_layout, container, false);
        speak2Btn=view.findViewById(R.id.btn_speak2);
        mVoiceInputTv=view.findViewById(R.id.voiceInput2);
        speak2Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getActivity(), "Question2", Toast.LENGTH_SHORT).show();
                startVoiceInput();
            }
        });
