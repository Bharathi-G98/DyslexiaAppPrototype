...
public class Spell2Fragment extends Fragment  implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_spell2, container, false);
        ...
        btnSpeak2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Toast.makeText(getActivity(), "Question 2:", Toast.LENGTH_SHORT).show();
                speakOut();
            }
    ...
    public void onInit(int status) {
        ...
        if (status == TextToSpeech.SUCCESS) {
            ...
            } else btnSpeak2.setEnabled(true);
